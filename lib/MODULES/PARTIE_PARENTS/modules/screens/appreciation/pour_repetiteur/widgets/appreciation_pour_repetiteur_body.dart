...
class AppreciationPourRepetiteurBody extends StatefulWidget {
  ...
  @override
  State<AppreciationPourRepetiteurBody> createState() =>
      _AppreciationPourRepetiteurBodyState();
}

class _AppreciationPourRepetiteurBodyState
    extends State<AppreciationPourRepetiteurBody> {
            ...
            child: DataTable(
              ...
              rows: appreciations.asMap().entries.map((entry) {
                ...
                final String nomRepetiteur =
                    appreciation['demande']['repetiteur']['user']['name'];
                final String appreciationSurRepetiteur =
                    appreciation['appreciation_parents'];
                final String reponseAdmin = appreciation['reponse_admin'] ?? '';

                TextEditingController _appreciationSurRepetiteur =
                    TextEditingController(text: appreciationSurRepetiteur);
                TextEditingController _reponseAdmin =
                    TextEditingController(text: reponseAdmin);
